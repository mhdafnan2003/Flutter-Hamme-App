...
mixin _$InteractionRecord {
 ...
 String get id; String? get fromUser; String? get fromUserName; String? get fromUserUsername; String? get fromUserProfileImageUrl; String? get fromUserShareCode; String get toUser; InteractionType get type; Map<String, dynamic>? get metadata; bool get respondedByCurrentUser; bool get matched; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fromUser,fromUserName,fromUserUsername,fromUserProfileImageUrl,fromUserShareCode,toUser,type,const DeepCollectionEquality().hash(metadata),respondedByCurrentUser,matched,createdAt);

@override
String toString() {
  return 'InteractionRecord(id: $id, fromUser: $fromUser, fromUserName: $fromUserName, fromUserUsername: $fromUserUsername, fromUserProfileImageUrl: $fromUserProfileImageUrl, fromUserShareCode: $fromUserShareCode, toUser: $toUser, type: $type, metadata: $metadata, respondedByCurrentUser: $respondedByCurrentUser, matched: $matched, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String? fromUser, String? fromUserName, String? fromUserUsername, String? fromUserProfileImageUrl, String? fromUserShareCode, String toUser, InteractionType type, Map<String, dynamic>? metadata, bool respondedByCurrentUser, bool matched, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? fromUser,  String? fromUserName,  String? fromUserUsername,  String? fromUserProfileImageUrl,  String? fromUserShareCode,  String toUser,  InteractionType type,  Map<String, dynamic>? metadata,  bool respondedByCurrentUser,  bool matched,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InteractionRecord() when $default != null:
return $default(_that.id,_that.fromUser,_that.fromUserName,_that.fromUserUsername,_that.fromUserProfileImageUrl,_that.fromUserShareCode,_that.toUser,_that.type,_that.metadata,_that.respondedByCurrentUser,_that.matched,_that.createdAt);case _:
  return orElse();
...
class _InteractionRecord implements InteractionRecord {
  const _InteractionRecord({required this.id, this.fromUser, this.fromUserName, this.fromUserUsername, this.fromUserProfileImageUrl, this.fromUserShareCode, required this.toUser, required this.type, final  Map<String, dynamic>? metadata, this.respondedByCurrentUser = false, this.matched = false, required this.createdAt}): _metadata = metadata;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fromUser,fromUserName,fromUserUsername,fromUserProfileImageUrl,fromUserShareCode,toUser,type,const DeepCollectionEquality().hash(_metadata),respondedByCurrentUser,matched,createdAt);
